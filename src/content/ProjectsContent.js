...
export const ProjectsContent = [
	{
		...
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Villa Kogelhof', false, /\.(png|jpe?g|svg)$/)),
	...
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/OWC Noordwestcluster', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
	{
		title: 'Villa Augustus',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Villa Augustus', false, /\.(png|jpe?g|svg)$/)),
	...
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Koningshof Gouda', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.woningbouw],
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Elektrokern Schuurman', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
	{
		title: 'Spa hotel L’Europe',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Hotel LEurope', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.hotelsSportEnZorg],
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Gemengde toren Gouda Oost', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.woningbouw],
	},
	{
		title: 'De Bolder',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/De Bolder', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
	{
		title: 'Clubhuis tennisvereniging IJburg',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Clubhuis tennisvereniging IJburg', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Land van Barendreght', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.woningbouw],
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Vredehofplein en bibliotheek Spijkenisse', false, /\.(png|jpe?g|svg)$/)),
	...
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Clubhuis Rijswijkse Golfclub', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
	{
		title: 'MC de Grebbe',
		...
		images: getImagesForProject(require.context('./img/Projects/MC de Grebbe', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.hotelsSportEnZorg],
	},
	{
		title: 'Merlet college Cuijck',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Merlet college Cuijck', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
	{
		...
		images: getImagesForProject(require.context('./img/Projects/Sociale werkplaats Haegheflor', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.hotelsSportEnZorg],
	},
	{
		title: 'Villa Bergen',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Villa Bergen', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.woningbouw],
	},
	{
		title: 'Baltic Tower - Poznan, Poland',
		description: '',
		images: getImagesForProject(require.context('./img/Projects/Baltic Tower - Poznan Poland', false, /\.(png|jpe?g|svg)$/)),
		category: [ProjectCategories.utiliteitbouw],
	},
];
